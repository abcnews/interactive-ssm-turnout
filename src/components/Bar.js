...
const Progress = styled.progress`
  ...
  &::-webkit-progress-value {
    transition: ${(props) =>
      props.shouldTransition ? `width .5s ${props.theme.bezier}` : 'none'};
  }
...
const Fill = styled(Progress)`
  ...
  box-shadow: inset 0 0 0 0.125rem ${(props) => props.theme.grey};
...
const Tick = styled(Progress)`
  ...
  &::-webkit-progress-value {
    border-right: 0.125rem solid ${(props) => props.theme.primaryDark};
    background: none;
  }
